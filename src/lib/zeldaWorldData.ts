    ...
    patrols: [
      {
        ...
        name: 'Grove Whisperer (East Round)',
        x: 2, y: 9,
        waypoints: [{ x: 2, y: 9 }, { x: 13, y: 9 }],
        speed: 1.3,
        prompt: 'A scammer prowls the vestibule — approach from behind, or be seen',
      },
      {
        id: 'patrol_whisper_south',
        name: 'Grove Whisperer (South Round)',
        x: 16, y: 13,
        waypoints: [{ x: 15, y: 13 }, { x: 4, y: 13 }],
        speed: 1.5,
