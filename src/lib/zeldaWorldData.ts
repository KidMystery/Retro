...
export const ZELDA_MAPS: { [act: number]: ZeldaMap } = {
  1: {
    ...
    height: 28,
      ...
      'T.........P.........~...TT.......P.....T',
      'T.........PT........~...TT.......P....PP',
      'T.........PPPPPPPPPP=PPDPPPPPPPPPPPPPPPP',
      'T.........TT........~P..TT.......P....PP',
      'T......F..TT........~P..TT.......P.....T',
      'T.........TT........~P..TT.......P.....T',
      'T.........PPPPPPPPPPPPPPPPPPPPPPPP..F..T',
      'T...#####.P.....F...~......F...........T',
      'T...#####.P.........~..................T',
      'T...#####.P.TTT...............TTTT.....T',
      'T...##.##PPPPPPPPPPPP.........TTTT.....T',
      'T...........TTT.T...TTTTTT..~~~~~T.....T',
      'T...........TTT.TT..TTTTTT..~~~~~T.TTT.T',
      'T...........PPPPTT..TTTTTT..~~~~~T.TTT.T',
      'T..................................TTT.T',
      'T......................................T',
      'TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT'
    ],
...
export const DUNGEONS: { [act: number]: DungeonConfig } = {
  1: {
    ...
    patrols: [
      {
        id: 'patrol_whisper_east',
        name: 'Grove Whisperer (Entry Round)',
        x: 2, y: 4,
        waypoints: [{ x: 2, y: 4 }, { x: 12, y: 4 }],
        speed: 1.3,
        prompt: 'A scammer prowls the entry hall — approach from behind, or be seen',
      },
      {
        id: 'patrol_whisper_south',
        name: 'Grove Whisperer (Vault Round)',
        x: 31, y: 16,
        waypoints: [{ x: 42, y: 16 }, { x: 31, y: 16 }],
        speed: 1.5,
        prompt: 'He forces bad trades on those he catches watching — stay unseen',
      },
    ],
    floors: [
